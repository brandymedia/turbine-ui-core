    ...
    'design' => [
        ...
        'variants' => [
            ...
            'default' => [
                ...
                'focus' => 'focus-within:border-slate-600 dark:focus-within:border-slate-400 focus-within:border-2',
            ...
            'brand' => [
                ...
                'focus' => 'focus-within:border-brand-600 dark:focus-within:border-brand-400 focus-within:border-2',
            ...
            'primary' => [
                ...
                'focus' => 'focus-within:border-cyan-600 dark:focus-within:border-cyan-400 focus-within:border-2',
            ...
            'success' => [
                ...
                'focus' => 'focus-within:border-emerald-600 dark:focus-within:border-emerald-400 focus-within:border-2',
            ...
            'warning' => [
                ...
                'focus' => 'focus-within:border-orange-600 dark:focus-within:border-orange-400 focus-within:border-2',
            ...
            'danger' => [
                ...
                'focus' => 'focus-within:border-red-600 dark:focus-within:border-red-400 focus-within:border-2',
        ...
        'components' => [
            ...
            'alert' => [
                'base' => 'flex flex-wrap items-center [&_svg]:fill-current [&_svg]:text-inherit [&_svg]:w-4 [&_svg]:hover:opacity-75',
                'sizes' => [
